...
const EVERYONE = [
  ...
  { cmd: '/pro coin', desc: 'Flip a coin and get heads or tails' },
...
const CHANNEL_SHORTCUTS = [
  ...
  { cmd: 'Remove From Channel', desc: 'Right-click → Message shortcuts. Removes a message that has been sent to the channel from a thread.' },
];
