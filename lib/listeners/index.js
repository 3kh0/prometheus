...
const files = readdirSync(__dirname).filter(f => f.endsWith('.js') && f !== 'index.js' && f !== 'appHome.js');
...
console.log(`[listeners] loaded ${[...listeners.values()].flat().length} listeners for events: ${[...listeners.keys()].join(', ')}`);
